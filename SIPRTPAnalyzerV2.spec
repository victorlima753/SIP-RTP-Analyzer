...
a = Analysis(
    ...
    hiddenimports=['siprtp_v2_core', 'siprtp_v2_db', 'siprtp_v2_export', 'siprtp_v2_benchmark', 'siprtp_v2_performance', 'siprtp_v2_report', 'siprtp_v2_tk_runtime', 'tkinter', 'tkinter.filedialog', 'tkinter.messagebox', 'tkinter.ttk', '_tkinter'],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
    excludes=[],
